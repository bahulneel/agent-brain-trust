...
This folder holds workspace-oriented guides: how the repository is laid out, how to build and validate, and how to install **without** building. For a short usage overview, see the root [README.md](../README.md). For **authoring** experts, topics, and panel skills, see [CONTRIBUTING.md](../CONTRIBUTING.md).
